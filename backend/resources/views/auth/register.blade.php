    ...
    <main
        ...
        <div
            ...
            <div class="text-center mb-8">
                ...
                <h2 class="text-3xl font-bold text-gray-800 dark:text-white transition-colors duration-200">Create an
                    Account</h2>
                <p class="text-gray-500 dark:text-gray-400 mt-2 transition-colors duration-200">Join us and start managing
                    your orders.</p>
            </div>
            ...
            <form action="{{ isset($isSeller) && $isSeller ? route('seller.register') : route('register') }}" method="POST"
                class="space-y-4">
                @csrf
                ...
                <div>
                    <label for="name"
                        class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 transition-colors duration-200">Full
                        Name</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            <i
                                class="hgi-stroke hgi-user text-gray-400 dark:text-gray-500 transition-colors duration-200"></i>
                        </div>
                ...
                @if(isset($isSeller) && $isSeller)
                    <div>
                        <label for="phone"
                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 transition-colors duration-200">Phone
                            Number</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <i
                                    class="hgi-stroke hgi-call text-gray-400 dark:text-gray-500 transition-colors duration-200"></i>
                            </div>
                            <input type="tel" id="phone" name="phone" value="{{ old('phone') }}" required
                                class="pl-10 w-full px-4 py-2.5 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-600 focus:border-transparent transition-all outline-none dark:text-white @error('phone') border-red-400 @enderror"
                ...
                <div>
                    <label for="password_confirmation"
                        class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 transition-colors duration-200">Confirm
                        Password</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            <i
                                class="hgi-stroke hgi-shield-check text-gray-400 dark:text-gray-500 transition-colors duration-200"></i>
                        </div>
            ...
            <div class="mt-8 text-center text-sm text-gray-600 dark:text-gray-400 transition-colors duration-200">
                ...
                <a href="{{ isset($isSeller) && $isSeller ? route('seller.login') : route('login') }}"
