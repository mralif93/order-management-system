    ...
    <div class="max-w-[1600px] mx-auto space-y-8 pb-12 transition-colors duration-300">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div class="animate__animated animate__fadeInLeft">
                <h1 class="text-3xl font-extrabold text-secondary-900 dark:text-white tracking-tight leading-none">Orders
                </h1>
                <p class="text-secondary-500 dark:text-slate-400 mt-2 font-medium">Track and fulfillment customer orders and
                    manage statuses.</p>
            </div>
            <div class="animate__animated animate__fadeInRight">
                <button
                    class="px-6 py-3 bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 text-secondary-700 dark:text-slate-300 rounded-2xl font-black hover:bg-gray-50 dark:hover:bg-slate-800 transition flex items-center gap-2 shadow-sm">
        ...
        <div
            ...
            <div
                ...
                <form action="{{ route('admin.orders.index') }}" method="GET" class="relative group w-full sm:w-96">
                    <i
                            ...
                            <tr class="hover:bg-primary-50/20 dark:hover:bg-primary-900/5 transition-colors group">
                                ...
                                <td class="py-5 px-6">
                                    @php
                                        ...
                                        $dName = $order->customer?->name ?? $order->guest_name ?? 'Guest';
                                        $dSub = $order->customer?->email ?? $order->guest_phone ?? '';
                                    @endphp
                                    <div class="flex items-center gap-3">
                                        <div
                                        ...
                                        <div>
                                            <div class="flex items-center gap-1.5">
                                                <p class="font-bold text-secondary-900 dark:text-white leading-none">
                                                    {{ $dName }}</p>
                                                @if($isGuest)<span
                                                class="px-1.5 py-0.5 bg-amber-100 dark:bg-amber-900/30 text-amber-600 text-[9px] font-black uppercase rounded">Guest</span>@endif
                                            </div>
                            ...
                            <tr>
                                <td colspan="6" class="py-20 text-center">
                                    <div class="flex flex-col items-center gap-3">
                                        ...
                                        <p class="text-secondary-500 dark:text-slate-400 font-bold tracking-tight">No orders
                                            listed yet.</p>
                                    </div>
                                </td>
                            </tr>
