...
@section('content')
    <div class="max-w-[1600px] mx-auto space-y-8 pb-12 transition-colors duration-300">
        ...
        <div class="animate__animated animate__fadeInDown">
            ...
            <p class="text-secondary-500 dark:text-slate-400 mt-2 font-medium">Add a new item to your catalog with pricing
                and stock details.</p>
        </div>
                ...
                <section class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                <span
                                    class="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 font-bold text-sm">USD</span>
                        ...
                        <div class="space-y-2">
                            ...
                            <select name="currency" required
                                ...
                                <option value="MYR" {{ old('currency') == 'MYR' || !old('currency') ? 'selected' : '' }}>MYR -
                                    Ringgit</option>
