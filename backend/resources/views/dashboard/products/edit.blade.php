...
<div class="max-w-4xl mx-auto space-y-8 pb-12 transition-colors duration-300">
    ...
    <div class="animate__animated animate__fadeInDown">
        ...
        <p class="text-secondary-500 dark:text-slate-400 mt-2 font-medium">Update SKU, pricing, and stock for <span class="text-primary-600 dark:text-primary-400 font-bold tracking-tight">"{{ $product->name }}"</span></p>
    </div>
    ...
    <form action="{{ route('products.update', $product) }}" method="POST" class="space-y-6">
            ...
            <section class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <span class="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 font-bold text-sm">{{ $product->currency ?: 'USD' }}</span>
                    ...
                    <div class="space-y-2">
                        ...
                        <select name="currency" required
                            ...
                            <option value="MYR" {{ old('currency', $product->currency) == 'MYR' ? 'selected' : '' }}>MYR - Ringgit</option>
                            <option value="SGD" {{ old('currency', $product->currency) == 'SGD' ? 'selected' : '' }}>SGD - Dollar</option>
                        </select>
                    </div>
        ...
        <div class="flex items-center justify-end gap-4">
            ...
            <button type="submit" class="px-8 py-3 bg-primary-600 text-white rounded-2xl font-black hover:bg-primary-700 hover:shadow-xl transition-all shadow-lg active:scale-95">
                Update Changes
            </button>
        </div>
    </form>
