...
@section('title', 'Edit Product | ' . $product->name . ' | OMS Admin')
...
@section('content')
    <div class="max-w-[1600px] mx-auto space-y-8 pb-12 transition-colors duration-300">
        ...
        <div class="animate__animated animate__fadeInDown">
            ...
            <p class="text-secondary-500 dark:text-slate-400 mt-2 font-medium">Update SKU, pricing, and stock for <span
                    class="text-primary-600 dark:text-primary-400 font-bold tracking-tight">"{{ $product->name }}"</span>
            </p>
        </div>
