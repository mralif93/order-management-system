...
@section('title', 'Profile Settings | Admin Portal')
...
<div x-data="{ tab: 'personal' }" class="max-w-[1600px] mx-auto space-y-8 pb-12">
    ...
    <div class="animate__animated animate__fadeInDown">
        ...
        <p class="text-secondary-500 dark:text-slate-400 mt-2 font-medium">Manage your admin profile and security preferences.</p>
    </div>
            ...
            <div x-show="tab==='personal'" class="animate__animated animate__fadeIn">
                <form action="{{ route('admin.profile.update') }}" method="POST"
                    ...
                    <div class="flex items-center gap-4 pb-6 border-b dark:border-slate-800">
                        ...
                        <div>
                            <h3 class="text-lg font-black text-secondary-900 dark:text-white uppercase tracking-tighter leading-none">{{ $admin->name }}</h3>
                            <p class="text-[10px] text-primary-600 dark:text-primary-400 font-black uppercase tracking-widest mt-1">Administrator</p>
                        </div>
                    </div>
