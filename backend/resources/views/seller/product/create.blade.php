...
@section('content')
    <div class="max-w-4xl mx-auto space-y-8 pb-12 transition-colors duration-300">
        ...
        <div class="animate__animated animate__fadeInDown">
            <h1 class="text-3xl font-extrabold text-secondary-900 dark:text-white tracking-tight">Add New Product</h1>
            <p class="text-secondary-500 dark:text-slate-400 mt-2 font-medium">Add a new item to your store with pricing and
                stock details.</p>
        </div>
        ...
        <form action="{{ route('seller.products.store') }}" method="POST" class="space-y-6">
                ...
                <section class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                <span
                                    class="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 font-bold text-sm">MYR</span>
                        ...
                        <div class="space-y-2">
                            ...
                            <select name="currency" required
                                ...
                                <option value="MYR" {{ old('currency', 'MYR') == 'MYR' ? 'selected' : '' }}>MYR - Ringgit
                                </option>
            ...
            <div class="flex items-center justify-end gap-4">
                ...
                <button type="submit"
                    class="px-8 py-3 bg-secondary-900 dark:bg-primary-600 text-white rounded-2xl font-black hover:shadow-xl transition-all shadow-lg active:scale-95">
                    Save Product
                </button>
            </div>
        </form>
